...
namespace Kerberos.Sots.Data
{
	internal class DataObjectCache
	{
		...
		public DiplomacyStatesCache diplomacy_states
		{
			get;
			private set;
		}
		public PlayersCache players
		{
			get;
			private set;
		}
		public Dictionary<int, List<int>> fleetShips
		{
			get;
			private set;
		}
		public TableCache<int, FleetInfo> fleets
		{
			get;
			private set;
		}
		public DesignsCache designs
		{
			get;
			private set;
		}
		public ShipsCache ships
		{
			get;
			private set;
		}
		public ColoniesCache colonies
		{
			get;
			private set;
		}
		public StationsCache stations
		{
			get;
			private set;
		}
		public SectionInstancesCache section_instances
		{
			get;
			private set;
		}
		public ArmorInstancesCache armor_instances
		{
			get;
			private set;
		}
		public WeaponInstancesCache weapon_instances
		{
			get;
			private set;
		}
		public ModuleInstancesCache module_instances
		{
			get;
			private set;
		}
		public MissionsCache missions
		{
			get;
			private set;
		}
		public ColonyTrapsCache colony_traps
		{
			get;
			private set;
		}
		public ExploreRecordsCache explore_records
		{
			get;
			private set;
		}
		public NodeLinesCache node_lines
		{
			get;
			private set;
		}
		public MoraleEventHistoryCache morale_event_history
		{
			get;
			private set;
		}
		public TableCache<int, StarSystemInfo> star_systems
		{
			get;
			private set;
		}
		public TableCache<PlayerTechInfo.PrimaryKey, PlayerTechInfo> player_techs
		{
			get;
			private set;
		}
		public TableCache<PlayerBranchInfo.PrimaryKey, PlayerBranchInfo> player_tech_branches
		{
			get;
			private set;
		}
		public Dictionary<int, Dictionary<string, int>> CachedPlayerShipNames
		{
			get;
			private set;
		}
		public Dictionary<int, HashSet<string>> CachedPlayerDesignNames
		{
			get;
			private set;
		}
		public Dictionary<DataObjectCache.SystemPlayerID, float> CachedSystemStratSensorRanges
		{
			get;
			private set;
		}
		public Dictionary<DataObjectCache.SystemPlayerID, bool> CachedSystemHasGateFlags
		{
			get;
			private set;
		}

...
namespace Kerberos.Sots.Data.WeaponFramework
{
	public class Weapon
	{
		...
		internal void AttachToXmlNode(ref XmlElement node)
		{
			...
			XmlHelper.AddObjectCollectionNode(this.PassThroughShields, "PassableShields", "Shield", ref node);
			XmlHelper.AddObjectCollectionNode(this.RequiredTech, "RequiredTechnologies", "Technology", ref node);
			XmlHelper.AddObjectCollectionNode(this.Attributes, "Attributes", "Attribute", ref node);
			XmlHelper.AddObjectCollectionNode(this.CompatibleSections, "CompatibleSections", "Section", ref node);
			XmlHelper.AddObjectCollectionNode(this.TurretClasses, "TurretClasses", "TurretClass", ref node);
			XmlHelper.AddObjectCollectionNode(this.DeployableSections, "DeployableSections", "Section", ref node);
			XmlHelper.AddObjectCollectionNode(this.CompatibleFactions, "CompatibleFactions", "Faction", ref node);
			XmlHelper.AddNode(this.PayloadType, "PayloadType", ref node);
			XmlHelper.AddNode(this.PlagueType, "PlagueType", ref node);
			XmlHelper.AddNode(this.WeaponSize, "WeaponSize", ref node);
			XmlHelper.AddNode(this.Animation, "Animation", ref node);
			XmlHelper.AddNode(this.AnimationDelay, "AnimationDelay", ref node);
			XmlHelper.AddNode(this.Cost, "Cost", ref node);
			XmlHelper.AddNode(this.Crew, "Crew", ref node);
			XmlHelper.AddNode(this.isCrewPerBank, "CrewPerBank", ref node);
			XmlHelper.AddNode(this.Power, "Power", ref node);
			XmlHelper.AddNode(this.isPowerPerBank, "PowerPerBank", ref node);
			XmlHelper.AddNode(this.Supply, "Supply", ref node);
			XmlHelper.AddNode(this.isSupplyPerBank, "SupplyPerBank", ref node);
			XmlHelper.AddNode(this.Signature, "Signature", ref node);
			XmlHelper.AddNode(this.isSignaturePerBank, "SignaturePerBank", ref node);
			XmlHelper.AddNode(this.HpBonus, "HpBonus", ref node);
			XmlHelper.AddNode(this.Health, "Health", ref node);
			XmlHelper.AddNode(this.TrackingSpeed, "TrackingSpeed", ref node);
			XmlHelper.AddNode(this.TimeToLive, "TimeToLive", ref node);
			XmlHelper.AddNode(this.DumbfireTime, "DumbfireTime", ref node);
			XmlHelper.AddNode(this.CritHitBonus, "CritHitBonus", ref node);
			XmlHelper.AddNode(this.MalfunctionPercent, "MalfunctionPercent", ref node);
			XmlHelper.AddNode(this.MalfunctionDamage, "MalfunctionDamage", ref node);
			XmlHelper.AddNode(this.SubweaponType, "SubweaponType", ref node);
			XmlHelper.AddNode(this.isVisible, "IsVisible", ref node);
			XmlHelper.AddNode(this.isAbductor, "IsAbductor", ref node);
			XmlHelper.AddNode(this.DisruptorValue, "DisruptorValue", ref node);
			XmlHelper.AddNode(this.DrainValue, "DrainValue", ref node);
			XmlHelper.AddNode(this.DOT, "DOT", ref node);
			XmlHelper.AddNode(this.SubmunitionType, "Submunition", ref node);
			XmlHelper.AddNode(this.SubmunitionAmount, "SubmunitionAmount", ref node);
			XmlHelper.AddNode(this.SubmunitionBlastType, "SubmunitionBlastType", ref node);
			XmlHelper.AddNode(this.SubmunitionConeDeviation, "SubmunitionConeDeviation", ref node);
			XmlHelper.AddNode(this.ExplosiveMinEffectRange, "ExplosiveMinEffectRange", ref node);
			XmlHelper.AddNode(this.ExplosiveMaxEffectRange, "ExplosiveMaxEffectRange", ref node);
			XmlHelper.AddNode(this.DetonationRange, "DetonationRange", ref node);
			XmlHelper.AddNode(this.EMPRange, "EMPRange", ref node);
			XmlHelper.AddNode(this.EMPDuration, "EMPDuration", ref node);
			XmlHelper.AddNode(this.ArmorPiercingLevel, "ArmorPiercingLevel", ref node);
			XmlHelper.AddNode(this.NumArcs, "NumArcs", ref node);
			XmlHelper.AddNode(this.ArcRange, "ArcRange", ref node);
			XmlHelper.AddNode(this.CritHitRolls, "CritHitRolls", ref node);
			XmlHelper.AddNode(this.MaxGravityForce, "MaxGravityForce", ref node);
			XmlHelper.AddNode(this.GravityAffectRange, "GravityAffectRange", ref node);
			XmlHelper.AddNode(this.PbGrid, "PbGrid", ref node);
			XmlHelper.AddNode(this.EffectiveGrid, "EffectiveGrid", ref node);
			XmlHelper.AddNode(this.MaxGrid, "MaxGrid", ref node);
			XmlHelper.AddNode(this.TrackSpeedModifier, "TrackSpeedModifier", ref node);
			XmlHelper.AddNode(this.BeamDamagePeriod, "BeamDamagePeriod", ref node);
			XmlHelper.AddNode(this.Volleys, "Volleys", ref node);
			XmlHelper.AddNode(this.VolleyPeriod, "VolleyPeriod", ref node);
			XmlHelper.AddNode(this.VolleyDelay, "VolleyDelay", ref node);
			XmlHelper.AddNode(this.BuildupDelay, "BuildupDelay", ref node);
			XmlHelper.AddNode(this.BaseVolleyDeviation, "BaseVolleyDeviationName", ref node);
			XmlHelper.AddNode(this.BaseRechargeTime, "BaseRechargeTime", ref node);
			XmlHelper.AddNode(this.MuzzleSpeed, "MuzzleSpeed", ref node);
			XmlHelper.AddNode(this.ShotAcceleration, "ShotAcceleration", ref node);
			XmlHelper.AddNode(this.Duration, "Duration", ref node);
			XmlHelper.AddNode(this.MuzzleSize, "MuzzleDescription", ref node);
			XmlHelper.AddNode(this.Model, "Model", ref node);
			XmlHelper.AddNode(this.DecalMaterial, "DecalMaterial", ref node);
			XmlHelper.AddNode(this.DecalSize, "DecalSize", ref node);
			XmlHelper.AddNode(this.MuzzleEffect, "MuzzleEffect", ref node);
			XmlHelper.AddNode(this.BuildupEffect, "BuildupEffect", ref node);
			XmlHelper.AddNode(this.ImpactEffect, "ImpactEffect", ref node);
			XmlHelper.AddNode(this.PlanetImpactEffect, "PlanetImpactEffect", ref node);
			XmlHelper.AddNode(this.BulletEffect, "BulletEffect", ref node);
			XmlHelper.AddNode(this.RicochetEffect, "RicochetEffect", ref node);
			XmlHelper.AddNode(this.isMuzzleEffectLooping, "isMuzzleEffectLooping", ref node);
			XmlHelper.AddNode(this.isBuildupEffectLooping, "isBuildupEffectLooping", ref node);
			XmlHelper.AddNode(this.isBulletEffectLooping, "isBulletEffectLooping", ref node);
			XmlHelper.AddNode(this.isImpactEffectLooping, "isImpactEffectLooping", ref node);
			XmlHelper.AddNode(this.isRicochetEffectLooping, "isRicochetEffectLooping", ref node);
			XmlHelper.AddNode(this.MuzzleSound, "MuzzleSound", ref node);
			XmlHelper.AddNode(this.BuildupSound, "BuildupSound", ref node);
			XmlHelper.AddNode(this.ImpactSound, "ImpactSound", ref node);
			XmlHelper.AddNode(this.PlanetImpactSound, "PlanetImpactSound", ref node);
			XmlHelper.AddNode(this.ExpireSound, "ExpireSound", ref node);
			XmlHelper.AddNode(this.BulletSound, "BulletSound", ref node);
			XmlHelper.AddNode(this.RicochetSound, "RicochetSound", ref node);
			XmlHelper.AddNode(this.Icon, "Icon", ref node);
			XmlHelper.AddNode(this.EffectiveRanges, "RangeTable", ref node);
			XmlHelper.AddNode(this.BaseRicochetModifier, "BaseRicochetModifier", ref node);
			XmlHelper.AddNode(this.RecoilFactor, "RecoilFactor", ref node);
			XmlHelper.AddNode(this.RoundMass, "RoundMass", ref node);
			XmlHelper.AddNode(this.PopDamage, "PopDamage", ref node);
			XmlHelper.AddNode(this.InfraDamage, "InfraDamage", ref node);
			XmlHelper.AddNode(this.TerraDamage, "TerraDamage", ref node);
			XmlHelper.AddNode(this.SolutionTolerance, "SolutionTolerance", ref node);
			XmlHelper.AddNode(this.RatingDamageEstimate, "RatingDamageEstimate", ref node);
			XmlHelper.AddNode(this.RatingFiringRate, "FiringRate", ref node);
			XmlHelper.AddNode(this.RatingAccuracy, "Accuracy", ref node);
			XmlHelper.AddNode(this.RatingRange, "Range", ref node);
		}

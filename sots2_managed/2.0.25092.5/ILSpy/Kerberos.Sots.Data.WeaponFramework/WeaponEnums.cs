...
namespace Kerberos.Sots.Data.WeaponFramework
{
	public class WeaponEnums
	{
		...
		private static readonly WeaponEnums.TurretClasses[] _battleRiderTypes = new WeaponEnums.TurretClasses[]
		{
		...
		public static readonly string[] _factions = new string[]
		{
			"human",
			"hiver",
			"tarkas",
		...
		public static readonly string[] _weaponIcons = new string[]
		{
			"bal_APdrv_heavy",
		...
		public static bool RequiresDesign(WeaponEnums.TurretClasses turretClass, out RealShipClasses correspondingShipClass)
		{
			switch (turretClass)
			{
		...
		{
			return WeaponEnums._battleRiderTypes.Contains(shipType);
		}
		public static bool IsPlanetAssaultWeapon(WeaponEnums.TurretClasses tc)
		{
			...
			case WeaponEnums.TurretClasses.Drone:
				return false;
			default:
				if (tc != WeaponEnums.TurretClasses.Siege)
				{
					return false;
				}
				break;
		...
		public static bool IsWeaponBattleRider(WeaponEnums.TurretClasses shipType)
		{
			...
			case WeaponEnums.TurretClasses.AssaultShuttle:
				break;
			default:
				if (shipType != WeaponEnums.TurretClasses.BoardingPod)
				{
					return false;
				}
				break;

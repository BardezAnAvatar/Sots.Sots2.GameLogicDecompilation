...
namespace Kerberos.Sots.UI
{
	internal class StationModules
	{
		public class StationModule
		{
			...
			public StationModule(string name, string desc, ModuleEnums.StationModuleType smtype, string slottype)
			{
				this.Name = name;
		...
		public static StationModules.StationModule[] Modules = new StationModules.StationModule[]
		{

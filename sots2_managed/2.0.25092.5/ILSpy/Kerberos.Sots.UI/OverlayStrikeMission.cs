...
namespace Kerberos.Sots.UI
{
	...
	{
		public OverlayStrikeMission(App game, StarMapState state, StarMap starmap, string template = "OverlaySurveyMission") : base(game, state, starmap, MissionType.STRIKE, template)
		{
		}
		...
		{
            Kerberos.Sots.StarFleet.StarFleet.SetStrikeMission(this.App.Game, base.SelectedFleet, base.TargetSystem, this._useDirectRoute, 0, 0, base.GetDesignsToBuild());
		...
		protected override string GetMissionDetailsTitle()
		{
			...
			return string.Format(App.Localize("@UI_STRIKE_OVERLAY_MISSION_TITLE"), starSystemInfo.Name.ToUpperInvariant());
		}
		protected override void OnRefreshMissionDetails(MissionEstimate estimate)
		{
			...
			base.AddMissionTime(2, App.Localize("@UI_STRIKE_TIME"), estimate.TurnsAtTarget, hint);
